...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: InlineQueryUpdateProcessor</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: InlineQueryUpdateProcessor</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>InlineQueryUpdateProcessor<span class="signature">(dataSource)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="InlineQueryUpdateProcessor"><span class="type-signature"></span>new InlineQueryUpdateProcessor<span class="signature">(dataSource)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="BaseTelegramDataSource.html">BaseTelegramDataSource</a></span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="updateProcessors_InlineQueryUpdateProcessor.js.html">updateProcessors/InlineQueryUpdateProcessor.js</a>, <a href="updateProcessors_InlineQueryUpdateProcessor.js.html#line11">line 11</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="process"><span class="type-signature"></span>process<span class="signature">(update)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="updateProcessors_InlineQueryUpdateProcessor.js.html">updateProcessors/InlineQueryUpdateProcessor.js</a>, <a href="updateProcessors_InlineQueryUpdateProcessor.js.html#line22">line 22</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="supports"><span class="type-signature"></span>supports<span class="signature">(update)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="updateProcessors_InlineQueryUpdateProcessor.js.html">updateProcessors/InlineQueryUpdateProcessor.js</a>, <a href="updateProcessors_InlineQueryUpdateProcessor.js.html#line91">line 91</a>
    </li></ul></dd>
