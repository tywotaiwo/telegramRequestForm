...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: WebAdmin</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: WebAdmin</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>WebAdmin<span class="signature">(host, port, path, logger, telegram)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="WebAdmin"><span class="type-signature"></span>new WebAdmin<span class="signature">(host, port, path, logger, telegram)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="WebAdminLogger.html">WebAdminLogger</a></span>
        ...
        <tr>
                ...
                <td class="name"><code>telegram</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="Telegram.html">Telegram</a></span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="webAdmin_server_WebAdmin.js.html">webAdmin/server/WebAdmin.js</a>, <a href="webAdmin_server_WebAdmin.js.html#line15">line 15</a>
    </li></ul></dd>
