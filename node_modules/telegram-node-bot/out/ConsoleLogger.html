...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ConsoleLogger</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ConsoleLogger</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ConsoleLogger<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Standard ConsoleLogger, will be used if no logger passed to Telegram</div>
...
<article>
    ...
    <h4 class="name" id="ConsoleLogger"><span class="type-signature"></span>new ConsoleLogger<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="logger_ConsoleLogger.js.html">logger/ConsoleLogger.js</a>, <a href="logger_ConsoleLogger.js.html#line15">line 15</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="error"><span class="type-signature"></span>error<span class="signature">(data)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="logger_ConsoleLogger.js.html">logger/ConsoleLogger.js</a>, <a href="logger_ConsoleLogger.js.html#line36">line 36</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="log"><span class="type-signature"></span>log<span class="signature">(data)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="logger_ConsoleLogger.js.html">logger/ConsoleLogger.js</a>, <a href="logger_ConsoleLogger.js.html#line20">line 20</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="warn"><span class="type-signature"></span>warn<span class="signature">(data)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="logger_ConsoleLogger.js.html">logger/ConsoleLogger.js</a>, <a href="logger_ConsoleLogger.js.html#line28">line 28</a>
    </li></ul></dd>
