...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: KeyboardButton</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: KeyboardButton</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>KeyboardButton<span class="signature">(text, requestContact<span class="signature-attributes">opt</span>, requestLocation<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">This object represents one button of the reply keyboard. For simple text buttons String can be used instead of this object to specify text of the button. Optional fields are mutually exclusive.</div>
...
<article>
    ...
    <h4 class="name" id="KeyboardButton"><span class="type-signature"></span>new KeyboardButton<span class="signature">(text, requestContact<span class="signature-attributes">opt</span>, requestLocation<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
        ...
        <tr>
                ...
                <td class="name"><code>requestContact</code></td>
...
<span class="param-type">null</span>
        ...
        <tr>
                ...
                <td class="name"><code>requestLocation</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_KeyboardButton.js.html">models/KeyboardButton.js</a>, <a href="models_KeyboardButton.js.html#line7">line 7</a>
    </li></ul></dd>
...
<h4 class="name" id="requestContact"><span class="type-signature"></span>requestContact<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_KeyboardButton.js.html">models/KeyboardButton.js</a>, <a href="models_KeyboardButton.js.html#line32">line 32</a>
    </li></ul></dd>
...
<h4 class="name" id="requestLocation"><span class="type-signature"></span>requestLocation<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_KeyboardButton.js.html">models/KeyboardButton.js</a>, <a href="models_KeyboardButton.js.html#line40">line 40</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_KeyboardButton.js.html">models/KeyboardButton.js</a>, <a href="models_KeyboardButton.js.html#line24">line 24</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".deserialize"><span class="type-signature">(static) </span>deserialize<span class="signature">(raw)</span><span class="type-signature"> &rarr; {<a href="KeyboardButton.html">KeyboardButton</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_KeyboardButton.js.html">models/KeyboardButton.js</a>, <a href="models_KeyboardButton.js.html#line49">line 49</a>
    </li></ul></dd>
...
<span class="param-type"><a href="KeyboardButton.html">KeyboardButton</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_KeyboardButton.js.html">models/KeyboardButton.js</a>, <a href="models_KeyboardButton.js.html#line57">line 57</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_KeyboardButton.js.html">models/KeyboardButton.js</a>, <a href="models_KeyboardButton.js.html#line69">line 69</a>
    </li></ul></dd>
