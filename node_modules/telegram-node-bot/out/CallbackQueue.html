...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: CallbackQueue</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: CallbackQueue</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>CallbackQueue<span class="signature">(countPerSec)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="CallbackQueue"><span class="type-signature"></span>new CallbackQueue<span class="signature">(countPerSec)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>countPerSec</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils_CallbackQueue.js.html">utils/CallbackQueue.js</a>, <a href="utils_CallbackQueue.js.html#line8">line 8</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="push"><span class="type-signature"></span>push<span class="signature">(func)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils_CallbackQueue.js.html">utils/CallbackQueue.js</a>, <a href="utils_CallbackQueue.js.html#line20">line 20</a>
    </li></ul></dd>
