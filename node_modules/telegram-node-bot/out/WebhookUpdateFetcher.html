...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: WebhookUpdateFetcher</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: WebhookUpdateFetcher</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>WebhookUpdateFetcher<span class="signature">(api, logger, url, host, port, apiToken)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="WebhookUpdateFetcher"><span class="type-signature"></span>new WebhookUpdateFetcher<span class="signature">(api, logger, url, host, port, apiToken)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="BaseLogger.html">BaseLogger</a></span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="updateFetchers_WebhookUpdateFetcher.js.html">updateFetchers/WebhookUpdateFetcher.js</a>, <a href="updateFetchers_WebhookUpdateFetcher.js.html#line16">line 16</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="fetch"><span class="type-signature"></span>fetch<span class="signature">(callback)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="global.html#fetchUpdatesCallback">fetchUpdatesCallback</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="updateFetchers_WebhookUpdateFetcher.js.html">updateFetchers/WebhookUpdateFetcher.js</a>, <a href="updateFetchers_WebhookUpdateFetcher.js.html#line30">line 30</a>
    </li></ul></dd>
