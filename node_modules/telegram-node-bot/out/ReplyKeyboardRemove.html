...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ReplyKeyboardRemove</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ReplyKeyboardRemove</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ReplyKeyboardRemove<span class="signature">(removeKeyboard, selective<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Upon receiving a message with this object, Telegram clients will remove the current custom keyboard and display the default letter-keyboard. By default, custom keyboards are displayed until a new keyboard is sent by a bot. An exception is made for one-time keyboards that are hidden immediately after the user presses a button (see ReplyKeyboardMarkup).</div>
...
<article>
    ...
    <h4 class="name" id="ReplyKeyboardRemove"><span class="type-signature"></span>new ReplyKeyboardRemove<span class="signature">(removeKeyboard, selective<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>removeKeyboard</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ReplyKeyboardRemove.js.html">models/ReplyKeyboardRemove.js</a>, <a href="models_ReplyKeyboardRemove.js.html#line7">line 7</a>
    </li></ul></dd>
...
<h4 class="name" id="removeKeyboard"><span class="type-signature"></span>removeKeyboard<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ReplyKeyboardRemove.js.html">models/ReplyKeyboardRemove.js</a>, <a href="models_ReplyKeyboardRemove.js.html#line22">line 22</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ReplyKeyboardRemove.js.html">models/ReplyKeyboardRemove.js</a>, <a href="models_ReplyKeyboardRemove.js.html#line30">line 30</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".deserialize"><span class="type-signature">(static) </span>deserialize<span class="signature">(raw)</span><span class="type-signature"> &rarr; {<a href="ReplyKeyboardRemove.html">ReplyKeyboardRemove</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ReplyKeyboardRemove.js.html">models/ReplyKeyboardRemove.js</a>, <a href="models_ReplyKeyboardRemove.js.html#line39">line 39</a>
    </li></ul></dd>
...
<span class="param-type"><a href="ReplyKeyboardRemove.html">ReplyKeyboardRemove</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ReplyKeyboardRemove.js.html">models/ReplyKeyboardRemove.js</a>, <a href="models_ReplyKeyboardRemove.js.html#line47">line 47</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ReplyKeyboardRemove.js.html">models/ReplyKeyboardRemove.js</a>, <a href="models_ReplyKeyboardRemove.js.html#line58">line 58</a>
    </li></ul></dd>
