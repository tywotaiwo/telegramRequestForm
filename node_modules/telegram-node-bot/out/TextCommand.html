...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TextCommand</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: TextCommand</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>TextCommand<span class="signature">(textPattern, handler<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="TextCommand"><span class="type-signature"></span>new TextCommand<span class="signature">(textPattern, handler<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>textPattern</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="routing_commands_TextCommand.js.html">routing/commands/TextCommand.js</a>, <a href="routing_commands_TextCommand.js.html#line10">line 10</a>
    </li></ul></dd>
...
<h4 class="name" id="handlerName"><span class="type-signature"></span>handlerName<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="routing_commands_TextCommand.js.html">routing/commands/TextCommand.js</a>, <a href="routing_commands_TextCommand.js.html#line28">line 28</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="test"><span class="type-signature"></span>test<span class="signature">(scope)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="routing_commands_TextCommand.js.html">routing/commands/TextCommand.js</a>, <a href="routing_commands_TextCommand.js.html#line20">line 20</a>
    </li></ul></dd>
