...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: BaseUpdateFetcher</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: BaseUpdateFetcher</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>BaseUpdateFetcher<span class="signature">(api, logger)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="BaseUpdateFetcher"><span class="type-signature"></span>new BaseUpdateFetcher<span class="signature">(api, logger)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="updateFetchers_BaseUpdateFetcher.js.html">updateFetchers/BaseUpdateFetcher.js</a>, <a href="updateFetchers_BaseUpdateFetcher.js.html#line8">line 8</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="updateFetchers_BaseUpdateFetcher.js.html">updateFetchers/BaseUpdateFetcher.js</a>, <a href="updateFetchers_BaseUpdateFetcher.js.html#line21">line 21</a>
    </li></ul></dd>
