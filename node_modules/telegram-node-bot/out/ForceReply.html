...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ForceReply</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ForceReply</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ForceReply<span class="signature">(forceReply, selective<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Upon receiving a message with this object, Telegram clients will display a reply interface to the user (act as if the user has selected the bot‘s message and tapped ’Reply'). This can be extremely useful if you want to create user-friendly step-by-step interfaces without having to sacrifice privacy mode.</div>
...
<article>
    ...
    <h4 class="name" id="ForceReply"><span class="type-signature"></span>new ForceReply<span class="signature">(forceReply, selective<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>forceReply</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ForceReply.js.html">models/ForceReply.js</a>, <a href="models_ForceReply.js.html#line7">line 7</a>
    </li></ul></dd>
...
<h4 class="name" id="forceReply"><span class="type-signature"></span>forceReply<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ForceReply.js.html">models/ForceReply.js</a>, <a href="models_ForceReply.js.html#line22">line 22</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ForceReply.js.html">models/ForceReply.js</a>, <a href="models_ForceReply.js.html#line30">line 30</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".deserialize"><span class="type-signature">(static) </span>deserialize<span class="signature">(raw)</span><span class="type-signature"> &rarr; {<a href="ForceReply.html">ForceReply</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ForceReply.js.html">models/ForceReply.js</a>, <a href="models_ForceReply.js.html#line39">line 39</a>
    </li></ul></dd>
...
<span class="param-type"><a href="ForceReply.html">ForceReply</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ForceReply.js.html">models/ForceReply.js</a>, <a href="models_ForceReply.js.html#line47">line 47</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ForceReply.js.html">models/ForceReply.js</a>, <a href="models_ForceReply.js.html#line58">line 58</a>
    </li></ul></dd>
