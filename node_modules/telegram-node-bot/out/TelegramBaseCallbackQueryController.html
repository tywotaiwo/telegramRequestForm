...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TelegramBaseCallbackQueryController</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: TelegramBaseCallbackQueryController</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>TelegramBaseCallbackQueryController<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Base Callback Query Controller
you must extend TelegramBaseCallbackQueryController 
to create callback query controller.</div>
...
<article>
    ...
    <h4 class="name" id="TelegramBaseCallbackQueryController"><span class="type-signature"></span>new TelegramBaseCallbackQueryController<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="mvc_TelegramBaseCallbackQueryController.js.html">mvc/TelegramBaseCallbackQueryController.js</a>, <a href="mvc_TelegramBaseCallbackQueryController.js.html#line8">line 8</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="handle"><span class="type-signature"></span>handle<span class="signature">(query)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="mvc_TelegramBaseCallbackQueryController.js.html">mvc/TelegramBaseCallbackQueryController.js</a>, <a href="mvc_TelegramBaseCallbackQueryController.js.html#line14">line 14</a>
    </li></ul></dd>
