...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ResponseParameters</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ResponseParameters</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ResponseParameters<span class="signature">(migrateToChatId<span class="signature-attributes">opt</span>, retryAfter<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Contains information about why a request was unsuccessfull.</div>
...
<article>
    ...
    <h4 class="name" id="ResponseParameters"><span class="type-signature"></span>new ResponseParameters<span class="signature">(migrateToChatId<span class="signature-attributes">opt</span>, retryAfter<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>migrateToChatId</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ResponseParameters.js.html">models/ResponseParameters.js</a>, <a href="models_ResponseParameters.js.html#line7">line 7</a>
    </li></ul></dd>
...
<h4 class="name" id="migrateToChatId"><span class="type-signature"></span>migrateToChatId<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ResponseParameters.js.html">models/ResponseParameters.js</a>, <a href="models_ResponseParameters.js.html#line22">line 22</a>
    </li></ul></dd>
...
<h4 class="name" id="retryAfter"><span class="type-signature"></span>retryAfter<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ResponseParameters.js.html">models/ResponseParameters.js</a>, <a href="models_ResponseParameters.js.html#line30">line 30</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".deserialize"><span class="type-signature">(static) </span>deserialize<span class="signature">(raw)</span><span class="type-signature"> &rarr; {<a href="ResponseParameters.html">ResponseParameters</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ResponseParameters.js.html">models/ResponseParameters.js</a>, <a href="models_ResponseParameters.js.html#line39">line 39</a>
    </li></ul></dd>
...
<span class="param-type"><a href="ResponseParameters.html">ResponseParameters</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ResponseParameters.js.html">models/ResponseParameters.js</a>, <a href="models_ResponseParameters.js.html#line47">line 47</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="models_ResponseParameters.js.html">models/ResponseParameters.js</a>, <a href="models_ResponseParameters.js.html#line58">line 58</a>
    </li></ul></dd>
