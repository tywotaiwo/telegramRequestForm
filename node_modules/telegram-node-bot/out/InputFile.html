...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: InputFile</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: InputFile</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>InputFile<span class="signature">(fileId, filePath, fileUrl, fileName)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">This class represents any file that's going be send to Telegram</div>
...
<article>
    ...
    <h4 class="name" id="InputFile"><span class="type-signature"></span>new InputFile<span class="signature">(fileId, filePath, fileUrl, fileName)</span><span class="type-signature"></span></h4>
...
<span class="param-type">null</span>
        ...
        <tr>
                ...
                <td class="name"><code>fileUrl</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_InputFile.js.html">api/InputFile.js</a>, <a href="api_InputFile.js.html#line39">line 39</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".byFilePath"><span class="type-signature">(static) </span>byFilePath<span class="signature">(path)</span><span class="type-signature"> &rarr; {<a href="InputFile.html">InputFile</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_InputFile.js.html">api/InputFile.js</a>, <a href="api_InputFile.js.html#line144">line 144</a>
    </li></ul></dd>
...
<span class="param-type"><a href="InputFile.html">InputFile</a></span>
    ...
    <h4 class="name" id=".byId"><span class="type-signature">(static) </span>byId<span class="signature">(id)</span><span class="type-signature"> &rarr; {<a href="InputFile.html">InputFile</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_InputFile.js.html">api/InputFile.js</a>, <a href="api_InputFile.js.html#line134">line 134</a>
    </li></ul></dd>
...
<span class="param-type"><a href="InputFile.html">InputFile</a></span>
    ...
    <h4 class="name" id=".byUrl"><span class="type-signature">(static) </span>byUrl<span class="signature">(url, fileName<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="InputFile.html">InputFile</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_InputFile.js.html">api/InputFile.js</a>, <a href="api_InputFile.js.html#line155">line 155</a>
    </li></ul></dd>
...
<span class="param-type"><a href="InputFile.html">InputFile</a></span>
    ...
    <h4 class="name" id=".deserialize"><span class="type-signature">(static) </span>deserialize<span class="signature">(raw)</span><span class="type-signature"> &rarr; {<a href="InputFile.html">InputFile</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_InputFile.js.html">api/InputFile.js</a>, <a href="api_InputFile.js.html#line114">line 114</a>
    </li></ul></dd>
...
<span class="param-type"><a href="InputFile.html">InputFile</a></span>
    ...
    <h4 class="name" id="prepareRequest"><span class="type-signature"></span>prepareRequest<span class="signature">(type, params)</span><span class="type-signature"> &rarr; {Promise.&lt;Object>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_InputFile.js.html">api/InputFile.js</a>, <a href="api_InputFile.js.html#line60">line 60</a>
    </li></ul></dd>
