...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TelegramBaseInlineQueryController</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: TelegramBaseInlineQueryController</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>TelegramBaseInlineQueryController<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Base inline query controller
you must extend TelegramBaseInlineQueryController
and override at least the handle method to create controller</div>
...
<article>
    ...
    <h4 class="name" id="TelegramBaseInlineQueryController"><span class="type-signature"></span>new TelegramBaseInlineQueryController<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="mvc_TelegramBaseInlineQueryController.js.html">mvc/TelegramBaseInlineQueryController.js</a>, <a href="mvc_TelegramBaseInlineQueryController.js.html#line8">line 8</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="mvc_TelegramBaseInlineQueryController.js.html">mvc/TelegramBaseInlineQueryController.js</a>, <a href="mvc_TelegramBaseInlineQueryController.js.html#line31">line 31</a>
    </li></ul></dd>
...
<h4 class="name" id="localization"><span class="type-signature"></span>localization<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="mvc_TelegramBaseInlineQueryController.js.html">mvc/TelegramBaseInlineQueryController.js</a>, <a href="mvc_TelegramBaseInlineQueryController.js.html#line39">line 39</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="chosenResult"><span class="type-signature"></span>chosenResult<span class="signature">(result)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="mvc_TelegramBaseInlineQueryController.js.html">mvc/TelegramBaseInlineQueryController.js</a>, <a href="mvc_TelegramBaseInlineQueryController.js.html#line25">line 25</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="handle"><span class="type-signature"></span>handle<span class="signature">(scope)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="InlineScope.html">InlineScope</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="mvc_TelegramBaseInlineQueryController.js.html">mvc/TelegramBaseInlineQueryController.js</a>, <a href="mvc_TelegramBaseInlineQueryController.js.html#line19">line 19</a>
    </li></ul></dd>
