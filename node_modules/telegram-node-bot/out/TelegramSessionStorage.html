...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TelegramSessionStorage</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: TelegramSessionStorage</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>TelegramSessionStorage<span class="signature">(storage)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="TelegramSessionStorage"><span class="type-signature"></span>new TelegramSessionStorage<span class="signature">(storage)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="storage_session_TelegramSessionStorage.js.html">storage/session/TelegramSessionStorage.js</a>, <a href="storage_session_TelegramSessionStorage.js.html#line11">line 11</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getChatSession"><span class="type-signature"></span>getChatSession<span class="signature">(chatId, key)</span><span class="type-signature"> &rarr; {Promise.&lt;*>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="storage_session_TelegramSessionStorage.js.html">storage/session/TelegramSessionStorage.js</a>, <a href="storage_session_TelegramSessionStorage.js.html#line47">line 47</a>
    </li></ul></dd>
...
<span class="param-type">Promise.&lt;*></span>
    ...
    <h4 class="name" id="getUserSession"><span class="type-signature"></span>getUserSession<span class="signature">(userId, key)</span><span class="type-signature"> &rarr; {Promise.&lt;*>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="storage_session_TelegramSessionStorage.js.html">storage/session/TelegramSessionStorage.js</a>, <a href="storage_session_TelegramSessionStorage.js.html#line21">line 21</a>
    </li></ul></dd>
...
<span class="param-type">Promise.&lt;*></span>
    ...
    <h4 class="name" id="setChatSession"><span class="type-signature"></span>setChatSession<span class="signature">(chatId, key, value)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="storage_session_TelegramSessionStorage.js.html">storage/session/TelegramSessionStorage.js</a>, <a href="storage_session_TelegramSessionStorage.js.html#line60">line 60</a>
    </li></ul></dd>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="setUserSession"><span class="type-signature"></span>setUserSession<span class="signature">(userId, key, value)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="storage_session_TelegramSessionStorage.js.html">storage/session/TelegramSessionStorage.js</a>, <a href="storage_session_TelegramSessionStorage.js.html#line34">line 34</a>
    </li></ul></dd>
